  ...
  return (
    <>
      <button
        ...
        className={`px-3 py-2 text-sm rounded-md transition-colors w-full whitespace-nowrap ${
          isSignup
            ...
            : `bg-transparent border border-primary-border-light text-primary-text-light
