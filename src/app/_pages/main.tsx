...
<Admonition type="warning" title="Important">
  This website is a front-end showcase and is not connected to a backend. As a result,
  form submissions and interactive features will not function as expected.
  The primary goal of this project is to demonstrate how the user experience
  dynamically adapts based on different layout selections.
</Admonition>
            <section>
              <LayoutToggle />
            </section>
