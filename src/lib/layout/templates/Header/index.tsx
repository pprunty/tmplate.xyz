...
const Header: React.FC = () => {
  ...
  return (
    <nav className="text-white dark:text-[#888] fixed top-0 left-0 w-full z-50 border-b dark:border-[#333] border-[#EAEAEA]">
      <div className="max-w-screen-xl mx-auto sm:px-6 xl:p-0">
        <div
          className={`overflow-hidden backdrop-blur-sm bg-theme-light/90 dark:bg-theme-dark/90 ${
        ...
        {/* Mobile Nav Links */}
        <div className="md:hidden py-2 backdrop-blur-sm bg-theme-light/70 dark:bg-theme-dark/70">
          <div
            ref={carouselRef}
