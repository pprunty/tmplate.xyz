...
import AuthButton from '@/lib/widgets/auth/templates/PopupButton';
import SearchBar from '@/lib/widgets/cta/components/SearchBar';
import ShoppingCart from '@/lib/widgets/cta/components/ShoppingCart';
import Notification from '@/lib/widgets/cta/components/Notification';
import ThemeSwitcher from '@/lib/widgets/common/templates/ThemeSwitcher'; // Import the ThemeSwitcher component
